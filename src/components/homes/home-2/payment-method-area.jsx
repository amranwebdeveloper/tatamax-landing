...
const payment_method_info = {
    title: <>Top Clients <br /> Technologies we use</>,
    desctiption: <>TATAMAX Solutions has grown into an international contestant in enterprise application development services with wide-ranging expertise in all areas needed for reliable software development.</>,
