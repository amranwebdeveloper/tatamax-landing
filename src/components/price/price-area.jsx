...
const pricing_data_monthly = {
   ...
   price_feature: [
      {
         id: 1,
         title: "Chances of launching your website",
      ...
      {
         id: 3,
         title: "Use any domain to get started fast",
         notice: <>Add gradient heading, button, pricing table testimonial etc.</>
      },
      {
         id: 4,
         title: "Launch & training call",
         notice: <>Add gradient heading, button, pricing table testimonial etc.</>
      },
      {
         id: 5,
      ...
      {
         id: 6,
         title: "Launch in 7 days only",
         notice: <>Add gradient heading, button, pricing table testimonial etc.</>
      },
      {
         id: 6,
         title: "Unlimited edits for 30 days",
         notice: <>Add gradient heading, button, pricing table testimonial etc.</>
      },
      {
         id: 7,
   ...
   price_feature_info: [
      {
         ...
         info: [
            ...
            <><i className="far fa-check"></i></>,
            <><i className="far fa-check"></i></>,
            "Hard to use, difficult to launch a website.",
         ]
                                    ...
                                    <div className="tp-price-top-wrapper">
                                       {price_header.map((item, i) =>
                                          <div key={i} className={`tp-price-top-item text-center ${item.active}`}>
                                             ...
                                             <div className={`tp-price-top-title-wrapper ${i === 1 ? 'active' : ''}`}>
